...
jest.mock("../src/scenes/createTask", () => jest.fn(() => <div>Create Task Page</div>));
jest.mock("../src/scenes/updateTask", () => jest.fn(() => <div>Update Task Page</div>));
jest.mock("../src/scenes/global/sidebar", () => jest.fn(() => <div>Sidebar</div>));
jest.mock("../src/scenes/global/topbar", () => jest.fn(() => <div>Topbar</div>));
